 ...
 * Main.java
 * <p>
 * Test class, that is needed to test {@link ModelAirlineCompanyTest}
...
public class ModelAirlineCompanyTest {
    private ModelAirlineCompanyTest<Aircraft> airlineCompany;

    @Before
    public void setUp() {
        airlineCompany = new ModelAirlineCompanyTest();
    }
